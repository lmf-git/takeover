...
export const defaults = { theme: 'light', user: null, isAuthenticated: false, counter: 0, meta: {} };
...
const store = new Store({ ...defaults, theme: getTheme(), user: getUser(), isAuthenticated: !!getUser() });
